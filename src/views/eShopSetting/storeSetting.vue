      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="Display" name="display">
          <el-form ref="display" :model="display">
            <el-checkbox v-model="display.is_allow_quantity_box" @change="changeQuantity">Quantity Box</el-checkbox>
            <el-checkbox v-model="display.is_allow_product_reviews" @change="changeProductReview">Allow Product Reviews</el-checkbox>
            <el-checkbox v-model="display.is_auto_approve_reviews" @change="changeAutoApproveReview">Auto Approve Reviews</el-checkbox>
            <el-checkbox v-model="display.is_enable_wishlist" @change="changeWishlist">Enable Wishlist</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_comparsion" @change="changeProductComparison">Enable Product Comparison</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_thumbnail_image" @change="changeProductThumbnail">Enable Product Thumbnail Images</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_price" @change="changeProductPrice">Show Product Price</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_brand" @change="changeProductBrand">Show Product Brand</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_shipping_price" @change="changeShippingCost">Show Product Shipping Cost</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_rating" @change="changeProductRating">Show Product Rating</el-checkbox>
            <el-checkbox v-model="display.is_enable_expected_delivery_date" @change="changeExpectedDelivery">Show Expected Delivery Date</el-checkbox>
            <el-checkbox v-model="display.is_enable_add_to_cart" @change="changeCart">Show "Add to Cart" Option</el-checkbox>
            <el-checkbox v-model="display.is_enable_product_sku" @change="changeProductSku">Show Product SKU</el-checkbox>

            <el-form-item label="New Product Parameter Set Up">
              <el-input v-model="display.new_product_days" @change="changeDays" placeholder="Enter the no. of day"></el-input>
            </el-form-item>
        ...
        <el-tab-pane label="Security &amp; Privacy " name="securityPrivacy">
          <el-form ref="security" :model="security">
            ...
            <el-checkbox v-model="security.is_enable_complex_password" @change="changeComplexPwd">
              Enforce complexity rule for shoppers password.
            </el-checkbox>
            <p>Cookie Consent Tracking</p>
            <el-checkbox v-model="security.is_enable_cookie_tracking" @change="changeCookieTracking">
              Yes, turn on cookie consent banner in my site.
            </el-checkbox>
            <p>Analytics for my business</p>
            <el-checkbox v-model="security.is_enable_analytics" @change="changeAnalytics">
              Track customer on screen behaviour (<a href="https://clicky.com/">https://clicky.com/</a>)
            </el-checkbox>
          </el-form>
        </el-tab-pane>
        ...
        <el-tab-pane label="Notification Settings" name="notificationSettings">
          <el-form ref="notification" :model="notification">
            ...
            <el-checkbox v-model="notification.is_product_review_notification" @change="changeReviewNotification">
              Send message / emails to customers asking to review the purchased products.
            </el-checkbox>
            <p>Forward Order Invoice</p>
            <el-checkbox v-model="notification.is_forward_order_invoice" @change="changeForwardOrder">
              Send message / emails of their order invoices</el-checkbox>
            <p>Forward Shipping Status</p>
            <el-checkbox v-model="notification.is_forward_shipping_status" @change="changeForwardShipping">
              Send message / email whenever there is a change in the shipping status of the product.
            </el-checkbox>
            <p class="checkboxHeading">
            <el-checkbox v-model="notification.is_enable_cart_notification" @change="changeCartNotification">
              Abandoned Card Notification
            </el-checkbox>
            </p>

            <p>Product Page Inventory Level Notification</p>
            <el-form-item>
              <el-radio-group v-model="notification.page_inventory_notification" @change="changePageInventory">
                <el-radio label="inventory_level_1_notification">
                  Always notify the current inventory level of the product in the product page of the e-shop
                </el-radio>
