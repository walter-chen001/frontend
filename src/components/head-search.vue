<template>
  <el-row :gutter="10" style="padding:0 15px;padding-top: 15px;margin-left:0;margin-right:0;border-bottom: 1px #eee solid;">
    <div class="search-bar">
      ...
      <div class="search-item search-btns">
        <el-button :disabled="false" type="success" size="small" @click="toSearch">
          <div v-if="false">
            <i class="el-icon-loading"></i>
          </div>
          <div v-else>{{$t('system.search')}}</div>
        </el-button>
        <el-button
          type="primary"
          size="small"
        ...
        >{{$t('system.advancedSearch')}}</el-button>
      </div>
    </div>
